...
# 全てのノードの次数(degree)の計算--Calculate degree for all nodes
nodeList <- cbind(nodeList, nodeDegree=igraph::degree(gD, v = igraph::V(gD), mode = "all"))

# 全てのノード間のbetweenness(媒介性)を計算 -Calculate betweenness for all nodes
...
# 全てのノード間のDice類似性指標を計算。 Calculate Dice similarities between all pairs of nodes
...
setwd("~/Documents/BBS_analysis/20180207")
